...
class CreateLogSatisDetallarisTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('log_satis_detallaris', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('log_satis_detallaris');
    }
}
