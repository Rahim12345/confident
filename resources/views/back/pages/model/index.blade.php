...
@section('title') Modellər @endsection
            ...
            <div class="col-12">
                <div class="card">
                    <div class="table-responsive">
                        <a href="{{ route('model.create') }}" class="btn btn-primary w-100">Əlavə et</a>
                        <table
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-list flex-nowrap">
                                        <a href="{{ route('model.edit',$item->id) }}" class="btn btn-primary">
                                            <i class="fa fa-pen"></i>
                                        </a>
                                        <div class="">
