            ...
            <div class="col-12">
                <div class="card">
                    <div class="table-responsive">
                        <a href="{{ route('kateqoriya.create') }}" class="btn btn-primary w-100">Əlavə et</a>
                        <table
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-list flex-nowrap">
                                        <a href="{{ route('kateqoriya.edit',$item->id) }}" class="btn btn-primary">
                                            <i class="fa fa-pen"></i>
                                        </a>
                                        <div class="">
                                            <form action="{{ route('kateqoriya.destroy',$item->id) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
