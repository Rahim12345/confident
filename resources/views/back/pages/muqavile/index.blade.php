...
@section('title') Müqavilələr @endsection
    ...
    <script>
        $(document).ready(function() {
            ...
            table.DataTable({
                ...
                ajax: {
                    url: "{{ route('muqavileler.index') }}",
                },
                columns: [
                    {data: 'satis_usulu_id', name: 'satis_usulu_id'},
                    {data: 'musteri_novu', name: 'musteri_novu'},
                    {data: 'musterinin_id', name: 'musterinin_id'},
                    {data: 'satici_id', name: 'satici_id'},
                    {
                ...
                createdRow: function( row, data, dataIndex ) {
                    $( row ).find('td:eq(0)').attr('data-label', 'Satış üsulu');
                    $( row ).find('td:eq(1)').attr('data-label', 'Müştəri növü');
                    $( row ).find('td:eq(2)').attr('data-label', 'Müştəri');
                    $( row ).find('td:eq(3)').attr('data-label', 'Satıcı');
                    $( row ).find('td:eq(4)').attr('data-label', 'Tarix');
