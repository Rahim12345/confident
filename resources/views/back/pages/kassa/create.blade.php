                ...
                <div class="row">
                    <div class="form-group mb-3 col-md-4">
                        ...
                        <select name="operation_type" id="operation_type"  class="form-control @error('operation_type') is-invalid  @enderror">
                            ...
                            <option value="1" {{ old('operation_type') == 1  ? 'selected' : '' }}>PERSONAL</option>
                            <option value="2" {{ old('operation_type') == 2  ? 'selected' : '' }}>FİRMA</option>
                            <option value="3" {{ old('operation_type') == 3  ? 'selected' : '' }}>DİGƏR</option>
                        </select>
                    ...
                    <div class="form-group mb-3 col-md-12" id="firma_id_div" style="display: {{ old('operation_type') == 2 ? 'block' : 'none' }}">
                    ...
                    <div class="form-group mb-3 col-md-12" id="personal_id_div" style="display: {{ old('operation_type') == 1 ? 'block' : 'none' }}">
