...
@section('title') Kassa @endsection
            ...
            <div class="col-12">
                <div class="card">
                    <div class="table-responsive">
                        <a href="{{ route('kassa.create') }}" class="btn btn-primary w-100">Əlavə et</a>
                        <table id="mehsullar"
    ...
    <script>
        $(document).ready(function() {
            ...
            table.DataTable({
                ...
                ajax: {
                    url: "{{ route('kassa.index') }}",
                },
                columns: [
                    {data: 'operation_id', name: 'operation_id'},
                    {data: 'pul', name: 'pul'},
                ...
                createdRow: function( row, data, dataIndex ) {
                    $( row ).find('td:eq(0)').attr('data-label', 'Operation');
                    $( row ).find('td:eq(1)').attr('data-label', 'Pul');
                    $( row ).find('td:eq(2)').attr('data-label', 'Təsvir');
