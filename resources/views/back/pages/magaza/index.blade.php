            ...
            <div class="col-12">
                <div class="card">
                    <div class="table-responsive">
                        <a href="{{ route('magaza.create') }}" class="btn btn-primary w-100">Əlavə et</a>
                        <table
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-list flex-nowrap">
                                        <a href="{{ route('magaza.edit',$item->id) }}" class="btn btn-primary">
                                            <i class="fa fa-pen"></i>
                                        </a>
                                        <div class="">
                                            <form action="{{ route('magaza.destroy',$item->id) }}" method="POST">
                                                @csrf
                                                @method('DELETE')
