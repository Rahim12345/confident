    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbar-menu">
            <ul class="navbar-nav pt-lg-3">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('satici.mehsullar') }}" >
...
@if(in_array(request()->segment(2),[
                    ...
                    @endif
                        ...
                        <div class="dropdown-menu-columns">
                            <div class="dropdown-menu-column">
                                @php
                                $satis_usullari = \App\Models\SatisUsulu::all();
                                @endphp
                                @foreach($satis_usullari as $item)
                                <a class="dropdown-item {{ request()->segment(3) == $item->id ? 'active' : '' }}" href="{{ route('satici.satis',['usul'=>$item->id]) }}">
                                    {{ $item->ad }}
                                </a>
                                @endforeach
                            </div>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('muqavileler.index') }}" >
                        <span class="nav-link-icon d-md-none d-lg-inline-block">
