        ...
        $(document).ready(function() {
            ...
            table.DataTable({
                ...
                createdRow: function( row, data, dataIndex ) {
                    ...
                    $( row ).find('td:eq(8)').attr('data-label', 'Topdan dəyəri');
                    $( row ).find('td:eq(9)').attr('data-label', 'Nağd dəyəri');
                    $( row ).find('td:eq(10)').attr('data-label', 'Kredit dəyəri');
                    $( row ).find('td:eq(11)').attr('data-label', 'Bir qutusundakı say');
                    $( row ).find('td:eq(12)').attr('data-label', 'Qutudakı 1 malın topdan dəyəri');
                    $( row ).find('td:eq(13)').attr('data-label', 'Qutudakı 1 malın nağd dəyəri');
                    $( row ).find('td:eq(14)').attr('data-label', 'Qutudakı 1 malın kredit dəyəri');
                },
                "language": {
